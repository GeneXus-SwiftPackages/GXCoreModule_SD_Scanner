...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Scanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Scanner-1.1.0-beta.12.xcframework.zip",
			checksum: "7b6b0d2dd746c9349c5b8505effebdbae22f29bc4ce9e26731004dbe2597016e"
		)
	]
)