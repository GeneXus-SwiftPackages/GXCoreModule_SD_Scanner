...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Scanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Scanner-1.0.0-beta.20230717172207.xcframework.zip",
			checksum: "29e0ecc07c6522716b2614b09e3a2e1763446cfb93ecba41ab8133a964d1e4bf"
		)
	]
)