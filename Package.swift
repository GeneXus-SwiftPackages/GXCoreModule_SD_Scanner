...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Scanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Scanner-1.0.0-beta.20230726144822.xcframework.zip",
			checksum: "f9766c8663a443d8ee20e3e1942d9603e95d23f66e677f8cdb6fbdf3ce02f8a1"
		)
	]
)