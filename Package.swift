...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Scanner",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Scanner-1.1.0-rc.3.xcframework.zip",
			checksum: "2a9060f4c9d975bac369ad55b83eb70592cd7897e3c995c2f09830c8ec51b9a8"
		)
	]
)