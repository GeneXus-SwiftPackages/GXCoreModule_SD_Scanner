...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Scanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Scanner-1.1.0-beta.9.xcframework.zip",
			checksum: "a7f5d68e4eb0bc319282940a61ae8cb9ecc39f791f675db36e84d059bb69dae4"
		)
	]
)