...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Scanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Scanner-1.0.0-beta.20230710193719.xcframework.zip",
			checksum: "26bf6deaeaf5286259703791f8f531b4a56cf25c3211af07c0e47dea43abece0"
		)
	]
)