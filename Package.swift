...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Scanner",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Scanner-1.1.0-rc.4.xcframework.zip",
			checksum: "0eadfacaf54f805f980fb15a0f89848f28a64f55dbb2d5b9cd0acacfa9f9fe67"
		)
	]
)