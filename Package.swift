...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Scanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Scanner-1.0.0-beta.20230710170706.xcframework.zip",
			checksum: "7cafbaa6093669df1a8b260c8dcd71eba16ec2dca5afdb4959898bdb01595eb3"
		)
	]
)