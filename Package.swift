...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Scanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Scanner-1.1.0-beta.10.xcframework.zip",
			checksum: "86204d8ecbc99ed9b88e3c5eb740713462c723946ef5835b2085c2bf4375abb8"
		)
	]
)