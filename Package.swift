...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Scanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Scanner-1.1.0-beta.795.xcframework.zip",
			checksum: "87c9e9ab9f0318086e819def1bf33a6759b4c5ff9078a9aeffe7be3896403bc0"
		)
	]
)